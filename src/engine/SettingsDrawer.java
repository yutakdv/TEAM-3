...
public final class SettingsDrawer { // NOPMD
  ...
  public void drawSettingMenu(final Screen screen) {
    ...
    drawManager.drawCenteredRegularString(screen, instructionsString2, screen.getHeight() / 4 - 18);
  }
  ...
  public void drawVolumeBar(
    ...
    drawSpeakerIcon(iconX, iconY, mutedVisual);
    ...
    final boolean hoverIndicator = isHoverIndicator(indicatorX, indicatorY);
  ...
  private boolean isHoverIndicator(final int indicatorX, final int indicatorY) {
    ...
    return mouseX >= indicatorX
        && mouseX <= indicatorX + 14
        && mouseY >= indicatorY
        && mouseY <= indicatorY + 14;
  }
  ...
  public void drawSettingLayout(
    ...
    g2d().drawLine(splitPointX, screen.getHeight() / 4, splitPointX, menuY + menuItems.length * 60);
  }
  ...
  private void drawSpeakerIcon(final int x, final int y, final boolean muted) {
    final Graphics2D g2d = g2d();
    g2d.setRenderingHint(
        java.awt.RenderingHints.KEY_ANTIALIASING, java.awt.RenderingHints.VALUE_ANTIALIAS_ON);

    final int squareW = 16;
    final int squareH = 16;
    ...
    if (muted) {
      ...
      g2d.drawLine(x + 10, y, x + 16 + 10, y + 16);
      g2d.drawLine(x + 10, y + 16, x + 16 + 10, y);
    } else {
      g2d.setColor(Color.WHITE);
      ...
      final int r1 = (int) (16 * 0.28);
      final int r3 = (int) (16 * 0.56);
